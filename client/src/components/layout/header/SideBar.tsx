  ...
  return (
    <div>
      ...
      <div className="d-none d-md-block">
        {/* Top Header with Logo and Language Selection */}
        <nav
              ...
              <div className="d-flex mx-auto gap-2">
                <Link
                  ...
                  style={{
                    ...
                    background: pathname.startsWith("/asl")
                      ? "linear-gradient(135deg, #7c3aed 0%, #a855f7 100%)"
                      : "rgba(124, 58, 237, 0.15)",
                    color: pathname.startsWith("/asl")
                      ? "white"
                      : "rgba(124, 58, 237, 1)",
                    border: pathname.startsWith("/asl")
                      ? "2px solid transparent"
                      : "2px solid rgba(124, 58, 237, 0.3)",
                    boxShadow: pathname.startsWith("/asl")
                      ? "0 4px 15px rgba(124, 58, 237, 0.4)"
                      : "none",
                  }}
                  onMouseEnter={(e) => {
                    if (!pathname.startsWith("/asl")) {
        ...
        <div
          ...
          style={{
            ...
            borderRight: `3px solid ${theme.badge}`,
            padding: "2rem 0",
            zIndex: 1030,
            ...
            <Link
              ...
              style={{
                ...
                color: pathname.includes("/signToText")
                  ...
                  : "rgba(255, 255, 255, 0.7)",
                textDecoration: "none",
                fontWeight: pathname.includes("/signToText") ? "700" : "600",
                fontSize: "1rem",
                transition: "all 0.3s ease",
                background: pathname.includes("/signToText")
                  ? theme.gradient
                  : "transparent",
                borderLeft: pathname.includes("/signToText")
                  ? `4px solid ${theme.light}`
                  : "4px solid transparent",
                margin: "0.5rem 0",
              }}
              onMouseEnter={(e) => {
                if (!pathname.includes("/signToText")) {
                  e.currentTarget.style.background = "rgba(255,255,255,0.1)";
                  e.currentTarget.style.paddingLeft = "2rem";
                }
              }}
            ...
            <Link
              ...
              style={{
                ...
                color: pathname.includes("/test")
                  ...
                  : "rgba(255, 255, 255, 0.7)",
                textDecoration: "none",
                fontWeight: pathname.includes("/test") ? "700" : "600",
                fontSize: "1rem",
                transition: "all 0.3s ease",
                background: pathname.includes("/test")
                  ? theme.gradient
                  : "transparent",
                borderLeft: pathname.includes("/test")
                  ? `4px solid ${theme.light}`
                  : "4px solid transparent",
                margin: "0.5rem 0",
              }}
            ...
            <Link
              ...
              style={{
                ...
                background: pathname.includes("/learn")
                  ? theme.gradient
                  : "transparent",
                borderLeft: pathname.includes("/learn")
                  ? `4px solid ${theme.light}`
                  : "4px solid transparent",
                margin: "0.5rem 0",
              }}
              ...
              <li>
                <button
                  ...
                  style={{
                    ...
                    padding: "0.6rem 1rem",
                    marginBottom: "0.3rem",
                    fontWeight: selectedChoice === "/asl" ? "700" : "500",
                  }}
                >
                  ASL
                </button>
