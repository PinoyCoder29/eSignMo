...
export default function ASLVideoQuiz() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        const res = await fetch("/api/test/testWord");
          ...
          >
            ...
            >
              {[
                {
                  num: "1",
                  title: "Watch Each Video",
                  desc: "Watch the ASL sign video demonstration carefully. You can play, pause, and replay as needed.",
                },
                {
                  num: "2",
        ...
        >
          ...
          >
            ...
            <p style={{ color: "#94a3b8", marginBottom: "1.5rem" }}>
              Are you sure you want to leave the ASL Video Quiz Assessment?
            </p>
            <div
            ...
            >
              ...
              <div style={{ marginBottom: "2rem" }}>
                ...
                <p style={{ color: "#94a3b8", fontSize: "0.9rem", margin: 0 }}>
                  Watch the video and identify the ASL sign
                </p>
              </div>
